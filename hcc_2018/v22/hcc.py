...
output,Col,Val,score_em,Score,score,Scores,NE,INS,institutional_score,age_range,
...
def community_regression_aged():
	reg_vars= ["F65_69","F70_74", "F75_79", "F80_84", "F85_89", "F90_94", "F95_GT",
...
def community_regression_disabled():
	reg_vars = ["F0_34","F35_44", "F45_54", "F55_59", "F60_64",
...
def new_enrollee_regression():
	reg_vars =['NMCAID_NORIGDIS_NEF0_34', 'NMCAID_NORIGDIS_NEF35_44', 
						 ...
						 'MCAID_NORIGDIS_NEF60_64', 'MCAID_NORIGDIS_NEF65', 'MCAID_NORIGDIS_NEF66',
						 'MCAID_NORIGDIS_NEF67', 'MCAID_NORIGDIS_NEF68', 'MCAID_NORIGDIS_NEF69',
						 'MCAID_NORIGDIS_NEF70_74', 'MCAID_NORIGDIS_NEF75_79', 'MCAID_NORIGDIS_NEF80_84',
						 'MCAID_NORIGDIS_NEF85_89', 'MCAID_NORIGDIS_NEF90_94', 'MCAID_NORIGDIS_NEF95_GT',
						 'MCAID_NORIGDIS_NEM0_34', 'MCAID_NORIGDIS_NEM35_44', 'MCAID_NORIGDIS_NEM45_54',
						 'MCAID_NORIGDIS_NEM55_59', 'MCAID_NORIGDIS_NEM60_64', 'MCAID_NORIGDIS_NEM65',
						 'MCAID_NORIGDIS_NEM66', 'MCAID_NORIGDIS_NEM67', 'MCAID_NORIGDIS_NEM68',
						 'MCAID_NORIGDIS_NEM69', 'MCAID_NORIGDIS_NEM70_74', 'MCAID_NORIGDIS_NEM75_79',
						 'MCAID_NORIGDIS_NEM80_84', 'MCAID_NORIGDIS_NEM85_89', 'MCAID_NORIGDIS_NEM90_94',
						 'MCAID_NORIGDIS_NEM95_GT', 'NMCAID_ORIGDIS_NEF65', 'NMCAID_ORIGDIS_NEF66',
						 'NMCAID_ORIGDIS_NEF67', 'NMCAID_ORIGDIS_NEF68', 'NMCAID_ORIGDIS_NEF69',
						 'NMCAID_ORIGDIS_NEF70_74', 'NMCAID_ORIGDIS_NEF75_79', 'NMCAID_ORIGDIS_NEF80_84',
						 'NMCAID_ORIGDIS_NEF85_89', 'NMCAID_ORIGDIS_NEF90_94', 'NMCAID_ORIGDIS_NEF95_GT',
						 'NMCAID_ORIGDIS_NEM65', 'NMCAID_ORIGDIS_NEM66', 'NMCAID_ORIGDIS_NEM67',
						 'NMCAID_ORIGDIS_NEM68', 'NMCAID_ORIGDIS_NEM69', 'NMCAID_ORIGDIS_NEM70_74',
						 'NMCAID_ORIGDIS_NEM75_79', 'NMCAID_ORIGDIS_NEM80_84', 'NMCAID_ORIGDIS_NEM85_89',
						 'NMCAID_ORIGDIS_NEM90_94', 'NMCAID_ORIGDIS_NEM95_GT', 'MCAID_ORIGDIS_NEF65',
						 'MCAID_ORIGDIS_NEF66', 'MCAID_ORIGDIS_NEF67', 'MCAID_ORIGDIS_NEF68',
						 'MCAID_ORIGDIS_NEF69', 'MCAID_ORIGDIS_NEF70_74', 'MCAID_ORIGDIS_NEF75_79',
						 'MCAID_ORIGDIS_NEF80_84', 'MCAID_ORIGDIS_NEF85_89', 'MCAID_ORIGDIS_NEF90_94',
						 'MCAID_ORIGDIS_NEF95_GT', 'MCAID_ORIGDIS_NEM65', 'MCAID_ORIGDIS_NEM66',
						 'MCAID_ORIGDIS_NEM67', 'MCAID_ORIGDIS_NEM68', 'MCAID_ORIGDIS_NEM69',
...
def institutional_regression():
	reg_vars = ["F0_34","F35_44", "F45_54", "F55_59", "F60_64", "F65_69",
							...
							"LTIMCAID","ORIGDS", "DISABLED_HCC85", "DISABLED_PRESSURE_ULCER",
							...
							"ART_OPENINGS_PRESSURE_ULCER", "DIABETES_CHF", "gCopdCF_ASP_SPEC_BACT_PNEUM", "ASP_SPEC_BACT_PNEUM_PRES_ULC",
...
def load_rules():
	...
	(community_full_benefit_dual_disabled_score[B] == sum_(Coef,key=Coef)) <=  indicator(B,CC) \
																								& CC.in_(cvarsa) & coefficient("CFD_"+CC,Coef)
	...
	(community_partial_benefit_dual_disabled_score[B] == sum_(Coef,key=Coef)) <=  indicator(B,CC) \
																								& CC.in_(cvarsa) & coefficient("CPD_"+CC,Coef)
